                ...
                <div className="flex flex-col items-center justify-center bg-gradient-to-r from-g-transp to-transparent p-5 mt-3">
                  ...
                  <div className="flex flex-row">
                    <a href="https://www.instagram.com/garounordeste/" target="_blank" rel="noreferrer">
                      <i className="fa-brands fa-instagram p-2 text-xl hover:text-crepusculo transition duration-1000"></i>
                    </a>
                    <a href="https://open.spotify.com/show/7kal4LDO3ptHc3sG64btYI" target="_blank" rel="noreferrer">
                      <i className="fa-brands fa-spotify p-2 text-xl hover:text-crepusculo transition duration-1000"></i>
                    </a>
                    <a href="https://www.youtube.com/c/GarouNordeste" target="_blank" rel="noreferrer">
                      <i className="fa-brands fa-youtube p-2 text-xl hover:text-crepusculo transition duration-1000"></i>
                    </a>
                    <a href="https://www.facebook.com/garounordeste" target="_blank" rel="noreferrer">
                      <i className="fa-brands fa-facebook-f p-2 text-xl hover:text-crepusculo transition duration-1000"></i>
                    </a>
                  </div>
                </div>
